...
% ----------------------------------------------------------
\begin{frame}[shrink=20]{What's Inside Your AI?}
...
% ----------------------------------------------------------
\begin{frame}[shrink=23]{What Is a Vector? --- Forces, Velocities, and Words}
...
% ----------------------------------------------------------
\begin{frame}[shrink=1]{Modern Vector Notation --- Gibbs and Heaviside}
...
% ----------------------------------------------------------
\begin{frame}[shrink=11]{Matrices --- Cayley and Sylvester}
...
% ----------------------------------------------------------
\begin{frame}[shrink=19]{Cosine Similarity --- Dot Product, Normalized}
...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{Eigenvalues --- The Natural Modes \hfill {\small\textcolor{gray}{[EXTENDED]}}}
  ...
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      ...
      \begin{personbox}[David Hilbert (1862--1943)]{digitalBlue}
        ...
        \textbf{Key work:} Extended eigenvalues to infinite-dimensional spaces (spectral theory, early 1900s).
      \end{personbox}
    \end{column}
...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{Attention as Matrix Multiplication --- A Preview}
...
% ----------------------------------------------------------
\begin{frame}[shrink=9]{Roots in Antiquity --- Archimedes and Infinitesimals}
...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{The Derivative --- Measuring Change}
  ...
  \begin{columns}[T]
    \begin{column}{0.47\textwidth}
      ...
      \vspace{0.2em}
      \begin{personbox}[G.\ W.\ Leibniz (1646--1716)]{enlightenmentTeal}
        \small
    ...
    \begin{column}{0.50\textwidth}
      ...
      \begin{tikzpicture}
        \node[draw=enlightenmentTeal!50, fill=enlightenmentTeal!5,
              rounded corners=2pt, inner sep=3pt, text width=1.15cm,
              align=center, font=\scriptsize]
          (fer) at (0,0) {\textbf{Fermat}\\[2pt]\resizebox{1.15cm}{!}{$\frac{f(x\!+\!e)-f(x)}{e}$}\\[1pt]{\tiny $e\!\to\!0$}};
        \node[draw=enlightenmentTeal!50, fill=enlightenmentTeal!5,
              rounded corners=2pt, inner sep=3pt, text width=1.15cm,
              align=center, font=\scriptsize]
          (new) at (2,0) {\textbf{Newton}\\[2pt]$\dot{y}$\\[1pt]{\tiny fluxion}};
        \node[draw=enlightenmentTeal!50, fill=enlightenmentTeal!5,
              rounded corners=2pt, inner sep=3pt, text width=1.15cm,
              align=center, font=\scriptsize]
          (lei) at (3.7,0) {\textbf{Leibniz}\\[2pt]$\frac{dy}{dx}$\\[1pt]{\tiny still used}};
        % Equals signs
        \node[font=\small] at (1,0) {$=$};
        \node[font=\small] at (2.8,0) {$=$};
        % Caption
        \node[font=\scriptsize\itshape, text=gray] at (1.85,-1.1)
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          axis lines=middle,
          ticks=none,
          xmin=-0.5, xmax=3.5, ymin=-0.3, ymax=4.5
        ]
...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{Gradient Descent --- Rolling Downhill \hfill {\small\textcolor{gray}{[EXTENDED]}}}
...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{Backpropagation --- The Algorithm That Changed Everything}
...
% ----------------------------------------------------------
\begin{frame}[shrink=8]{Stochastic Gradient Descent --- Learning from Samples}
...
% ----------------------------------------------------------
\begin{frame}[shrink=8]{Building the Diagram --- Calculus Complete}
