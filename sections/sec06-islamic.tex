...
\begin{frame}[shrink=3]{The Translation Movement}
  \begin{columns}[T]
...
\begin{frame}[shrink=18]{Muhammad ibn Musa al-Khwarizmi --- The Father of Algebra}
  \begin{columns}[T]
...
\begin{frame}[shrink=25]{Thabit ibn Qurra --- Translator and Innovator}
  \begin{columns}[T]
    \column{0.55\textwidth}
...
% ---- Slide 42: Abu Kamil ----
\begin{frame}[shrink=5]{Abu Kamil --- Extending the Algebra}
  \begin{columns}[T]
    \column{0.55\textwidth}
...
% ---- Slide 43: Al-Karaji ----
\begin{frame}[shrink=3]{Al-Karaji --- Algebra Freed from Geometry}
  \begin{columns}[T]
    \column{0.55\textwidth}
...
\begin{frame}[shrink=19]{Ibn al-Haytham --- The First Scientist?}
  \begin{columns}[T]
    \column{0.55\textwidth}
  ...
  \note{
    ...
    NARRATIVE BEAT -- THE THREAT: ``All of this -- the House of Wisdom, these
    scholars, these manuscripts -- was about to face an existential threat.
    The Mongol invasion of 1258 would destroy Baghdad and, according to legend,
    turn the Tigris black with ink from discarded books. Much was lost. But not
    everything -- because by then, the knowledge had already begun flowing west
    to Toledo and Sicily. The relay survived, but barely.'' [This adds tension
    to the middle of the Islamic section.]
  }
\end{frame}

% ---- Slide 46: Al-Biruni ----
\begin{frame}[shrink=8]{Al-Biruni --- The Polymath \hfill {\small\textcolor{islamicGreen!60}{[EXTENDED]}}}
  \begin{columns}[T]
...
\begin{frame}[shrink=25]{Al-Samawal \& Sharaf al-Din al-Tusi \hfill {\small\textcolor{islamicGreen!60}{[EXTENDED]}}}
  \begin{columns}[T]
    \column{0.48\textwidth}
...
\begin{frame}[shrink=4]{Nasir al-Din al-Tusi --- Trigonometry Becomes Its Own Field}
  \begin{columns}[T]
    \column{0.53\textwidth}
...
\begin{frame}[shrink=18]{Jamshid al-Kashi --- Master of Computation}
  \begin{columns}[T]
    \column{0.55\textwidth}
...
\begin{frame}[shrink=25]{Islamic Mathematics: Legacy and Transmission}
  \begin{columns}[T]
