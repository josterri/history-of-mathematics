...
% ----------------------------------------------------------
\begin{frame}{Grigori Perelman --- Solving the Unsolvable, Refusing the Prize}
...
% ----------------------------------------------------------
\begin{frame}{Terence Tao --- The Mozart of Math}
...
% ----------------------------------------------------------
\begin{frame}{Maryam Mirzakhani --- Breaking Barriers}
...
% ----------------------------------------------------------
\begin{frame}{Karen Uhlenbeck --- Geometry and Gauge Theory}
...
% ----------------------------------------------------------
\begin{frame}{Machine Learning --- The New Mathematics}
...
% ----------------------------------------------------------
\begin{frame}{Key Themes --- What Have We Learned?}
