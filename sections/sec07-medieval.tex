...
% ---- Slide 52: Fibonacci ----
\begin{frame}[shrink=25]{Fibonacci --- Bringing Arabic Mathematics to Europe}
  \begin{columns}[T]
...
\begin{frame}[shrink=25]{Nicole Oresme --- Graphs Before Descartes}
  \begin{columns}[T]
...
% ---- Slide 54: Pascal ----
\begin{frame}[shrink=25]{Blaise Pascal --- Probability and the Triangle}
  \begin{columns}[T]
