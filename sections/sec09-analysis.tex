...
% ---- Slide 67: Euler ----
\begin{frame}[shrink=16]{Leonhard Euler --- The Most Prolific Mathematician in History}
  \begin{columns}[T]
  ...
  \note{
    ...
    NARRATIVE: Ask the class: ``He went blind -- and kept going. 866 papers,
    many dictated from memory. WHY? What drives someone to do mathematics even
    when they can no longer see?'' The same calculus that explains planetary
    orbits would later be used for ballistics. Power has consequences.
  }
\end{frame}

% ---- Slide 68: Lagrange ----
\begin{frame}[shrink=22]{Joseph-Louis Lagrange \hfill {\small\textcolor{enlightenmentTeal!60}{[EXTENDED]}}}
  \begin{columns}[T]
    \column{0.52\textwidth}
...
% ---- Slide 69: Laplace ----
\begin{frame}[shrink=20]{Pierre-Simon Laplace \hfill {\small\textcolor{enlightenmentTeal!60}{[EXTENDED]}}}
  \begin{columns}[T]
    \column{0.52\textwidth}
...
% ---- Slide 70: Gauss ----
\begin{frame}[shrink=25]{Carl Friedrich Gauss --- \textit{Princeps Mathematicorum}}
  \begin{columns}[T]
  ...
  \note{
    ...
    NARRATIVE: ``Gauss kept notebooks full of results he never published. Other
    mathematicians spent years proving things Gauss had already found and tucked
    away. The relay's prince -- but also its gatekeeper.''
  }
\end{frame}
