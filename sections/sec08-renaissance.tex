...
\begin{frame}{Cardano and the Cubic Equation --- A Mathematical Drama}
  \begin{columns}[T]
...
% ---- Slide 58: Viete ----
\begin{frame}{Fran\c{c}ois Vi\`{e}te --- Symbolic Algebra}
  \begin{columns}[T]
    \column{0.50\textwidth}
...
% ---- Slide 59: Napier ----
\begin{frame}{John Napier --- Logarithms Change Everything}
  \begin{columns}[T]
...
% ---- Slide 61: Fermat ----
\begin{frame}{Pierre de Fermat --- The Prince of Amateurs}
  \begin{columns}[T]
    \column{0.52\textwidth}
...
% ---- Slide 62: Newton ----
\begin{frame}{Isaac Newton --- The Method of Fluxions}
  \begin{columns}[T]
    \column{0.52\textwidth}
...
% ---- Slide 63: Leibniz ----
\begin{frame}{Gottfried Wilhelm Leibniz --- The Notation that Won}
  \begin{columns}[T]
    \column{0.50\textwidth}
...
\begin{frame}{The Bernoulli Family --- A Mathematical Dynasty}
  \begin{columns}[T]
    \column{0.45\textwidth}
...
\begin{frame}{Calculus Invented --- The Floodgates Open}
  \centering
