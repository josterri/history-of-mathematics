...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{Thank You --- Questions?}
  ...
  \begin{center}
    \begin{tcolorbox}[colframe=digitalBlue,colback=white,boxrule=1pt,arc=4pt,width=0.85\textwidth]
      \centering
      \begin{columns}
        \column{0.35\textwidth}\centering
        {\large\faImage}\\[4pt]
        {\footnotesize\textit{Ishango bone}\\c.\ 20,000 BCE\\[2pt]Tally marks on bone}
        \column{0.1\textwidth}\centering
        {\Huge\textcolor{accentOrange}{$\longrightarrow$}}
        \column{0.35\textwidth}\centering
        {\large\faRobot}\\[4pt]
        {\footnotesize\textit{AI-assisted proof}\\2026 CE\\[2pt]Neural networks do mathematics}
      \end{columns}
      \vspace{0.5em}
      {\large\bfseries\textcolor{digitalBlue}{5,000 years.\ \ One story.\ \ Not over.}}
    \end{tcolorbox}
  \end{center}
...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{Further Reading}
