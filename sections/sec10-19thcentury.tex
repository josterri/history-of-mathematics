...
% ----------------------------------------------------------
\begin{frame}[shrink=18]{Evariste Galois --- Genius Cut Short}
...
% ----------------------------------------------------------
\begin{frame}[shrink=11]{Bernhard Riemann --- Curved Spaces and a Million-Dollar Question}
...
% ----------------------------------------------------------
\begin{frame}[shrink=24]{Georg Cantor --- Infinity Has Sizes}
...
% ----------------------------------------------------------
\begin{frame}[shrink=22]{Emmy Noether --- The Mother of Modern Algebra}
...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{Srinivasa Ramanujan --- The Self-Taught Genius}
...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{Sofia Kovalevskaya --- First Woman Doctorate in Mathematics}
