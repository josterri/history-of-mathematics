...
% ----------------------------------------------------------
\begin{frame}{The Ishango Bone --- The Oldest Mathematics?}
...
% ----------------------------------------------------------
\begin{frame}{Babylon --- The First Mathematicians}
...
% ----------------------------------------------------------
\begin{frame}{Plimpton 322 --- A 3,800-Year-Old Mystery}
...
% ----------------------------------------------------------
\begin{frame}{Egyptian Mathematics --- Practical Genius}
...
% ----------------------------------------------------------
\begin{frame}{Ahmes --- The Oldest Named Mathematician}
...
% ----------------------------------------------------------
\begin{frame}{Egyptian Geometry in Action}
...
% ----------------------------------------------------------
\begin{frame}{Mesopotamian Algebra}
...
% ----------------------------------------------------------
\begin{frame}{Mayan Mathematics --- An Independent Tradition}
