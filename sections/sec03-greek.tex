...
% ----------------------------------------------------------
\begin{frame}[shrink=5]{Thales of Miletus}
...
% ----------------------------------------------------------
\begin{frame}[shrink=8]{Pythagoras and the Pythagoreans}
...
% ----------------------------------------------------------
\begin{frame}[shrink=4]{Euclid --- \emph{The Elements}}
...
% ----------------------------------------------------------
\begin{frame}[shrink=22]{Archimedes --- The Greatest?}
...
% ----------------------------------------------------------
\begin{frame}[shrink=3]{Eratosthenes --- Measuring the Earth}
...
% ----------------------------------------------------------
\begin{frame}[shrink=25]{Apollonius --- Conic Sections}
...
% ----------------------------------------------------------
\begin{frame}[shrink=4]{Diophantus --- Father of Algebra?}
...
% ----------------------------------------------------------
\begin{frame}[shrink=23]{Hypatia of Alexandria}
...
% ----------------------------------------------------------
\begin{frame}[shrink=19]{Greek Legacy and the Great Transition}
