...
% ----------------------------------------------------------
\begin{frame}[shrink=20]{David Hilbert --- The Foundations Crisis}
  ...
  \note{
    ...
    PACING: This is the most intellectually disorienting idea in the lecture.
    After stating ``true statements that cannot be proved,'' STOP. Count to
    five in your head. Let the silence do the work. Do NOT rush to the next
    point. The students need time to feel the vertigo.
  }
\end{frame}
...
% ----------------------------------------------------------
\begin{frame}[shrink=17]{Alan Turing --- The Birth of Computer Science}
...
% ----------------------------------------------------------
\begin{frame}[shrink=8]{John von Neumann --- The Last Great Polymath}
...
% ----------------------------------------------------------
\begin{frame}[shrink=11]{John Nash --- Game Theory and the Nash Equilibrium}
