  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.47\textwidth}
      ...
      \begin{tcolorbox}[colback=accentOrange!10, colframe=accentOrange,
        ...
        rounded corners, boxrule=1.5pt, left=4pt, right=4pt, top=4pt, bottom=4pt]
        \centering\large
...
\begin{frame}{Linear Algebra --- The Skeleton Assembled}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \vspace{0.5em}
      {\small\itshape One node lit. Nine to go.\\[6pt]
...
\begin{frame}{Calculus --- The Learning Engine Assembled}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \vspace{0.5em}
      {\small\itshape Two nodes lit.\\[6pt]
...
\begin{frame}{From Gambling to Prediction}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      % Pascal-Fermat exchange
      \begin{tikzpicture}[
        letter/.style={draw=probBlue!60, rounded corners, fill=probBlue!5,
          text width=1.6cm, align=center, font=\scriptsize, inner sep=3pt},
        >=Stealth
      ]
        \node[letter] (pascal) at (0,0) {Pascal\\Paris};
        \node[letter] (fermat) at (3,0) {Fermat\\Toulouse};
        \draw[->,thick,probBlue!70] (pascal.east) --
          node[above,font=\tiny] {1654} (fermat.west);
        \draw[<-,thick,probBlue!70] ([yshift=-3pt]pascal.east)
          -- ([yshift=-3pt]fermat.west);
      \end{tikzpicture}

      \vspace{0.3em}
      % Bayes theorem
      \begin{tcolorbox}[colback=probBlue!5, colframe=probBlue,
        fonttitle=\bfseries\small, title={Bayes (1763)},
        rounded corners, boxrule=0.5pt, left=3pt, right=3pt, top=2pt, bottom=2pt]
        \small
    ...
    \begin{column}{0.49\textwidth}
      ...
      \begin{tcolorbox}[colback=infoAmber!8, colframe=infoAmber,
        fonttitle=\bfseries\small, title={Shannon (1948) --- Language as Statistics},
        rounded corners, boxrule=0.5pt, left=3pt, right=3pt, top=2pt, bottom=2pt]
        \scriptsize
...
\begin{frame}{Logic \& Computation --- The Substrate}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.49\textwidth}
      ...
      \vspace{0.3em}
      {\scriptsize\itshape ``Boole was a self-taught son of a shoemaker who reduced
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.47\textwidth}
      \begin{tcolorbox}[colback=approxGreen!5, colframe=approxGreen,
        ...
        \scriptsize
        \textbf{Fourier} (1807)\\
        Any function as a sum of sines.\\[3pt]
        \textbf{Weierstrass} (1885)\\
        Polynomials can approximate anything.\\[3pt]
        \textbf{Cybenko} (1989)\\
...
\begin{frame}{The Neuron \& Depth --- Seven Nodes Lit}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \vspace{0.3em}
      {\small\itshape Seven nodes lit.\\[4pt]
       We can build neurons, stack them deep, and train them.\\[4pt]
    ...
    \begin{column}{0.52\textwidth}
      \begin{tikzpicture}[
        ...
        \node[comp, draw=probBlue, fill=probBlue!10] (soft) at (0,4.2)
          {Output Softmax};
        \node[font=\tiny, text=probBlue, right] at (2.8,4.2)
          {Boltzmann 1870s};
