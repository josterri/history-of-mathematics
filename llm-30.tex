...
\begin{frame}{What's Inside Your AI?}
  ...
  \begin{columns}[T]
    \begin{column}{0.46\textwidth}
      ...
      \begin{tcolorbox}[colback=accentOrange!10, colframe=accentOrange,
        fonttitle=\bfseries\small, title={\faLightbulb\ Key Insight},
        rounded corners, boxrule=1pt, left=3pt, right=3pt, top=1pt, bottom=1pt]
  ...
  \vspace{-0.6em}
  \begin{center}
  \scriptsize\textcolor{gray}{The people inside your AI:}\hspace{4pt}%
  \includegraphics[height=0.48cm]{figures/euler.jpg}\hspace{2pt}%
  \includegraphics[height=0.48cm]{figures/gauss.jpg}\hspace{2pt}%
  \includegraphics[height=0.48cm]{figures/pascal.jpg}\hspace{2pt}%
  \includegraphics[height=0.48cm]{figures/turing.jpg}\hspace{2pt}%
  \includegraphics[height=0.48cm]{figures/shannon.jpg}\hspace{2pt}%
  \includegraphics[height=0.48cm]{figures/hinton.jpg}
  \end{center}
    ...
    \begin{column}{0.45\textwidth}
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          % Tangent line at the second ball (x=-1.2)
          \addplot[accentOrange, thick, domain=-2.2:-0.2, samples=2]
            {-1.7*(x+1.2) + 4.8};
          \fill[accentOrange] (axis cs:-1.2,4.8) circle (2.5pt);
          \node[font=\tiny, right, text=accentOrange] at (axis cs:-0.4,6.0)
            {slope $=$ derivative};
          % Gradient arrow pointing downhill
          \draw[-Stealth, thick, calculusRed!80] (axis cs:-1.2,4.8) -- (axis cs:-0.3,3.3);
          \node[font=\tiny, below, text=calculusRed] at (axis cs:-0.75,3.6)
            {gradient descent};
        \end{axis}
      \end{tikzpicture}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.49\textwidth}
      ...
      \begin{tcolorbox}[colback=infoAmber!8, colframe=infoAmber,
        fonttitle=\bfseries\small,
        title={\raisebox{-0.4em}{\includegraphics[height=1cm,clip]{figures/shannon.jpg}}%
          ~Shannon (1948)},
        rounded corners, boxrule=0.5pt, left=3pt, right=3pt, top=2pt, bottom=2pt]
        \scriptsize
...
\begin{frame}{Function Approximation --- The Guarantee}
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      ...
      \vspace{0.1em}
      % Neural network approximation stages
      \begin{tikzpicture}
        \begin{axis}[
          ...
          % Target function (bumpy)
          \addplot[black, very thick]
            {sin(deg(x)) + 0.3*sin(deg(3*x))};
          \addlegendentry{target}
          % 1 neuron (very rough)
          \addplot[calculusRed!60, dashed]
            {0.8*sin(deg(x))};
          \addlegendentry{1 neuron}
          % 5 neurons (better)
          \addplot[probBlue!70, dashed]
            {sin(deg(x)) + 0.1*sin(deg(3*x))};
          \addlegendentry{5 neurons}
          % 100 neurons (near perfect)
          \addplot[approxGreen, densely dotted, very thick]
            {sin(deg(x)) + 0.28*sin(deg(3*x))};
          \addlegendentry{100 neurons}
        \end{axis}
      \end{tikzpicture}%
      {\scriptsize\centering More neurons $\to$ better fit. \emph{Cybenko, 1989.}\par}
    \end{column}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.49\textwidth}
      \begin{tcolorbox}[colback=neuronPink!5, colframe=neuronPink,
        ...
        \vspace{0.2em}
        NYT: ``\,a machine that could walk, talk, see, write\ldots\!''
        ...
        \centering
        \includegraphics[height=1.5cm]{figures/perceptron.jpg}\\[1pt]
        {\tiny Mark\,I Perceptron}
        \end{minipage}
      \end{tcolorbox}
  ...
  \begin{center}
    \begin{tcolorbox}[colback=aiViolet!5, colframe=aiViolet,
      ...
      \begin{tabular}{@{}c@{\hskip 4pt}lll@{}}
        ...
        \raisebox{-0.15cm}{\includegraphics[height=0.4cm]{figures/fermat.jpg}}
        & Gradient descent & Cauchy & 1847 \\
        \raisebox{-0.15cm}{\includegraphics[height=0.4cm]{figures/hinton.jpg}}
        & Backpropagation & Linnainmaa, Hinton & 1970, 1986 \\
        \raisebox{-0.15cm}{\includegraphics[height=0.4cm]{figures/shannon.jpg}}
